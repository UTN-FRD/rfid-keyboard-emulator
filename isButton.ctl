...
Private Sub UserControl_AmbientChanged(PropertyName As String)
    Debug.Print Me.Caption & " - Ambient Changed! : " & PropertyName
            ...
            ElseIf m_iState = stateHot Then
                If m_iStyle = isbOfficeXP Then
                    ...
                    If m_UseMaskColor Then
                        'Paint in the about pic
                        pMask.PaintPicture m_Icon, ix, iy, m_IconSize, m_IconSize, , , , , vbSrcCopy
                        For nj = iy To iy + m_IconSize - 1
                            For ni = ix To ix + m_IconSize - 1
                                lcurrpix = GetPixel(pMask.hdc, ni, nj)
                ...
                If m_bEnabled Then
                    ...
                    For nj = iy To iy + m_IconSize - 1
                        For ni = ix To ix + m_IconSize - 1
                            lcurrpix = GetPixel(pMask.hdc, ni, nj)
                            If lcurrpix <> m_MaskColor Then
                                SetPixel UserControl.hdc, ni, nj, lcurrpix
                            End If
                        Next ni
                    Next nj
                Else
                    ...
                    For nj = iy To iy + m_IconSize - 1
                        For ni = ix To ix + m_IconSize - 1
                            lcurrpix = GetPixel(pMask.hdc, ni, nj)
                            If lcurrpix <> m_MaskColor Then
                                SetPixel UserControl.hdc, ni, nj, lGrayScale(lcurrpix)
                            End If
                        Next ni
                    Next nj
                End If
...
Private Sub UserControl_Show()
    ...
    m_bVisible = True
    UserControl_Paint
    'debug.print "Tooltiptext: Show Control"
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
  ...
  If Ambient.UserMode Then                                                              'If we're not in design mode
    ...
    End If
  End If
  'debug.print "Tooltiptext: Read properties"
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    End With
    'debug.print "Tooltiptext:    write properties"
End Sub
